...
func (noopTaskRepository) CreateTask(context.Context, *core.Task) error { return fmt.Errorf("task repository unavailable") }
func (noopTaskRepository) UpdateTask(context.Context, *core.Task) error { return fmt.Errorf("task repository unavailable") }
